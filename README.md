...
`stampit` is a JavaScript module which implements the [stamp specification](https://www.gitbook.com/book/stampit-org/docs/edit#). Stamps are composable factory function.
